      ...
      <div className="container mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="font-body text-white/70 text-sm leading-relaxed">
            A Wing of Dharma Jyothi Charitable Society. Dedicated to serving
            humanity through education, health, and community welfare programs.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {[
              ...
              >
                <span className="w-1.5 h-1.5 rounded-full bg-green/60"></span>
                {prog}
              </li>
            ))}
          </ul>
      ...
      <div className="border-t border-white/10 py-4">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2 text-center">
          <p className="font-body text-white/50 text-xs">
            © {new Date().getFullYear()} Dharma Jyothi Social Centre. All rights
            reserved.
          </p>
